...
const Hero = () => {
  return (
    <div className="w-full h-screen relative">
      ...
      <div className="absolute bottom-[35vh] left-[calc(2/12*100%)] xl:w-[calc((100%-260px)/12)] max-xl:w-[calc((100%-260px)/6)] max-md:w-[calc((100%-260px)/3)] max-sm:w-[calc((100%-260px)/1.5)] transform origin-bottom-left body-small border-t pt-2 border-black">
        Every job has its perfect match. We find yours.
      </div>
      <div className="absolute bottom-[35vh] right-[calc(2/12*100%)] xl:w-[calc((100%-260px)/12)] max-xl:w-[calc((100%-260px)/6)] max-md:w-[calc((100%-260px)/3)] max-sm:w-[calc((100%-260px)/1.5)] transform origin-bottom-left body-small text-right border-b pb-2 border-black">
